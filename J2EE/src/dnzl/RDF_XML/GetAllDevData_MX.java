...
public class GetAllDevData_MX extends HeadXml {
	...
	public static void main(String[] args) {
		...
		GetAllDevData_MX fs = new GetAllDevData_MX();

		List<String> xml_list = null;
		try {
			xml_list = XmlFactory.GetXMLAll_MXSB();
	...
	public static void writetofile(String xml) throws IOException{
		...
		String file_name = "/datafile/dnzl/taizhang/mx/"+"mx_"+str_time+".xml";
