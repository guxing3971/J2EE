...
import dnzl.Core.Extract_FTP_SuperClass;

public class Extract_FTP_FGP extends Extract_FTP_SuperClass {
	public SimpleDateFormat sdf2 = new SimpleDateFormat("yyyyMMdd_HH");
